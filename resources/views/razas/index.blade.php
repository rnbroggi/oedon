                                    ...
                                    <tbody>
                                        @foreach ($razas as $raza)
                                            <tr>
                                                <td>{{ $raza->id }}</td>
                                                <td>{{ $raza->nombre }}</td>
                                                <td>{{ $raza->animal->nombre ?? null }}</td>
                                                <td>
                                                    <a href="{{ route('razas.edit', $raza->id) }}">
                                                        <i class="feather icon-edit"></i>
                                                    </a>
                                                    <span class="delete-button" data-id="{{ $raza->id }}"><i
    ...
    <script>
        $( document ).ready(function() {
            ...
            $(document.body).on('click', '.delete-button', function () {
                ...
                Swal.fire({
                  title: '¿Seguro de que deseas eliminar esta raza?',
                  type: 'warning',
