            ...
            <div class="col-md-12 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Editar raza {{ $raza->nombre }}</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form novalidate class="form" action="{{ route('razas.update', $raza->id) }}" method="POST">
                                @csrf
                                @method('PATCH')
                                <div class="form-body">
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="select2 form-control" name="animal_id">
                                                    ...
                                                    @foreach ($animales as $animal)
                                                        <option value="{{ $animal->id }}"@if($animal->id == $raza->animal_id) selected @endif>
