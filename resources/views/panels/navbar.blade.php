        ...
        <div class="navbar-collapse" id="navbar-mobile">
          ...
          <ul class="nav navbar-nav float-right">
            ...
            <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#"
                ...
                <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600">{{ ucfirst(auth()->user()->name) }}</span><span class="user-status">Conectado</span></div><span><img class="round"
                    src="{{ auth()->user()->getFirstMedia('avatar') ? auth()->user()->getFirstMedia('avatar')->getUrl() : asset('images/portrait/small/avatar-s-0.jpg') }}" alt="avatar" height="40"
                    width="40" /></span>
              </a>
              <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="{{ route('profile') }}"><i
                    class="feather icon-user"></i> Perfil</a>
                ...
                @impersonating($guard = null)
                  <a class="dropdown-item" href="{{ route('impersonate_leave') }}">
                    <i class="feather icon-arrow-left"></i> Volver al admin
                  </a>
                @endImpersonating
                <div class="dropdown-divider"></div><a class="dropdown-item" href="{{ route('logout') }}"onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i
