    ...
    var defaults = {
        ...
        builtInValidators: {
            ...
            integer: {
                ...
                type: "regex",
                regex: "[+-]?\\d+",
                message: "No se permiten decimales<!-- data-validator-integer-message to override -->"
            },
            positivenumber: {
                name: "Positivenumber",
                type: "min",
                min: 0,
                message: "Debe ser un número positivo<!-- data-validator-positivenumber-message to override -->"
            },
            negativenumber: {
                name: "Negativenumber",
                type: "max",
                max: 0,
                message: "Debe ser un número negativo<!-- data-validator-negativenumber-message to override -->"
            },
            required: {
                name: "Required",
                type: "required",
            ...
            checkone: {
                ...
                type: "minchecked",
                minchecked: 1,
                message: "Hay que marcar al menos una opción<!-- data-validation-checkone-message to override -->"
            },
            number: {
                name: "Number",
                type: "number",
